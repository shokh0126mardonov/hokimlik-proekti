...
class AplicationPermission(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user and (
            ...
            or request.user.hokim
            or request.user.service_staff
            or request.user.oqsoqol
        )
...
class AplicationCreatePermission(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user and (request.user.super_admin or request.user.service_staff)
