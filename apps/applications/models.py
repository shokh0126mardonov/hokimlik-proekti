...
class Application(models.Model):
    ...
    app_number = models.CharField(max_length=30, unique=True,verbose_name="Ariza raqami")
    ...
    citizen_phone = models.CharField(max_length=20, null=True, blank=True,verbose_name="Telefon (ixtiyoriy)")
